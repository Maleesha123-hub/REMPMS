...
//    }
    ...
    public ResponseEntity<Object> handleRecordNotFoundException(RecordNotFoundException ex) {
        logg.error("handleRecordNotFoundException : {}", ex.getMessage());
        CommonResponse commonResponse = new CommonResponse(HttpStatus.NOT_FOUND, ex.getMessage(), null, LocalDateTime.now());
